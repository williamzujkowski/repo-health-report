...
**Analyzed:** 2026-04-03T12:55:09.108Z
...
| Grade distribution | A:0 B:4 C:9 D:11 F:88 |
...
- **Pinned dependencies (Actions SHA)** — 118 repos (100%) [supply-chain]
  - Pin all GitHub Actions to full commit SHA
- **Token permissions** — 115 repos (97%) [supply-chain]
...
- [ ] **Pinned dependencies (Actions SHA)** (100% fail rate) — Pin all GitHub Actions to full commit SHA
- [ ] **Token permissions** (97% fail rate) — Add explicit permissions block to GitHub Actions workflows
...
| uaa-bot | B | 80 | Python | application |
| cg-ui | B | 80 | TypeScript | application |
| django-uaa | C | 79 | Python | application |
| ubuntu-mirror | N/A | 79 | — | documentation |
| pages-site-gantry | C | 78 | TypeScript | application |
| pages-editor | C | 77 | TypeScript | application |
| pages-redirects | C | 76 | JavaScript | library |
| pages-build-container | C | 75 | Python | application |
| uaa-extras | C | 75 | Python | application |
| external-domain-broker | C | 75 | Python | application |
| pages-bot | C | 72 | JavaScript | application |
| caulking | C | 71 | Shell | application |
| cvd-sync | N/A | 71 | Shell | documentation |
| purge-sandboxes | D | 69 | Go | application |
| aws_opensearch_preprocess_lambdas | D | 68 | Python | application |
| pages-proxy | D | 67 | JavaScript | application |
| compliance-docs | N/A | 65 | Makefile | documentation |
| buildpack-notify | D | 65 | Go | application |
| pages-mailer | D | 65 | JavaScript | application |
| playwright-python | N/A | 65 | Shell | documentation |
| github-pr-resource | D | 64 | Go | application |
| sandbox-bot | D | 63 | Ruby | application |
| terraform-provision | D | 63 | HCL | iac |
| .github | N/A | 63 | — | documentation |
| s3-broker | D | 61 | Go | application |
| billing | D | 61 | Go | hybrid |
| stratos | D | 60 | TypeScript | application |
| csb | F | 59 | HCL | iac |
| nessus-manager-boshrelease | F | 58 | Shell | application |
| cf-service-connect | F | 57 | Go | application |
| manage-rds | F | 57 | Python | application |
| snort-boshrelease | F | 56 | Shell | application |
| Shibboleth-IdP3-TOTP-Auth | F | 55 | Java | application |
| cert-check | F | 55 | Python | application |
| site | F | 55 | Astro | application |
| deploy-logsearch | F | 54 | Shell | application |
| deploy-shibboleth | F | 54 | Python | application |
| pages-cf-build-tasks | F | 54 | JavaScript | application |
| login-migrator-bot | F | 54 | Ruby | application |
| aws-broker | F | 53 | Go | hybrid |
| deploy-postfix | F | 53 | Shell | application |
| github-release-resource | F | 53 | Go | application |
| deploy-platform-opensearch | F | 53 | Python | application |
| deploy-logs-opensearch | F | 51 | Python | application |
| deploy-stratos | F | 50 | HTML | application |
| secureproxy-boshrelease | F | 49 | Perl | application |
| uaa-credentials-broker | F | 49 | Go | application |
| uaa-customized-boshrelease | F | 49 | CSS | application |
| deploy-opsuaa | F | 49 | — | application |
| aws-elasticsearch-example | F | 49 | Python | application |
| opensearch-alerting | F | 49 | Kotlin | application |
| s3-simple-resource | F | 48 | Shell | application |
| deploy-nessus-manager | F | 48 | — | application |
| deploy-s3-broker | F | 48 | Shell | application |
| deploy-prometheus | F | 48 | Python | application |
| deploy-autoscaler | F | 48 | Shell | application |
| cf-hello-worlds | F | 47 | Java | application |
| s3-resource | F | 47 | Go | application |
| oci-build-task | F | 47 | Go | application |
| clamav-rest-image | F | 47 | Shell | application |
| general-task | F | 46 | Shell | library |
| deploy-bosh | F | 46 | Shell | application |
| pages-uswds-11ty | F | 46 | HTML | application |
| doomsday | F | 46 | Go | application |
| zap-runner | F | 46 | Dockerfile | application |
| deploy-doomsday | F | 45 | — | application |
| python3-boshrelease | F | 44 | Shell | application |
| deploy-credhub | F | 44 | HCL | iac |
| common-pipelines | F | 43 | Dockerfile | application |
| demo-cg-identity | F | 43 | JavaScript | application |
| deploy-cf | F | 42 | Shell | iac |
| slack-notification-resource | F | 42 | Shell | application |
| cf-resource | F | 42 | Go | application |
| opensearch-notifications | F | 42 | Kotlin | application |
| cg-scripts | F | 41 | Python | library |
| nessus-agent-boshrelease | F | 41 | Shell | application |
| laboratory | F | 41 | Go | application |
| go-broker-tags | F | 41 | Go | application |
| pages-images | F | 41 | Shell | application |
| bosh-deployment-resource | F | 41 | Go | application |
| pages-uswds-gatsby | F | 40 | JavaScript | application |
| metrics-dashboard | F | 40 | JavaScript | application |
| mysql-8-stig-overlay | F | 40 | Ruby | application |
| godojo | F | 39 | Go | application |
| pages-example-api-website | F | 39 | HTML | application |
| postgres-client-boshrelease | F | 39 | Shell | application |
| aide-boshrelease | F | 38 | Shell | application |
| opensearch-boshrelease | F | 38 | HTML | application |
| deploy-defectdojo | F | 38 | Shell | application |
| go-cfenv | F | 38 | Go | application |
| logsearch-for-cloudfoundry | F | 37 | HTML | application |
| pipeline-tasks | F | 37 | Shell | application |
| deploy-concourse | F | 37 | Shell | iac |
| shibboleth-boshrelease | F | 37 | HTML | application |
| oauth2-proxy-boshrelease | F | 37 | Shell | application |
| pages-pipeline-tasks | F | 37 | Shell | application |
| intranet-demo | F | 37 | Shell | application |
| cg-cli-tools | F | 36 | Shell | application |
| pages-example-website-api | F | 35 | Python | application |
| harden-boshrelease | F | 34 | Shell | application |
| pages-example-spa | F | 33 | JavaScript | application |
| cron-resource | F | 33 | Go | application |
| cron-boshrelease | F | 33 | Shell | application |
| logsearch-boshrelease | F | 32 | Shell | hybrid |
| cf-common | F | 32 | — | application |
| clamav-boshrelease | F | 31 | Shell | application |
| postfix-boshrelease | F | 30 | Shell | application |
| pages-404-page | N/A | 30 | HTML | documentation |
| upload-github-to-s3 | F | 30 | Shell | application |
| defectdojo-boshrelease | F | 30 | HTML | application |
| wordpress-example | F | 29 | PHP | application |
| homebrew-cloudgov | F | 24 | Ruby | application |
| ubuntu-hardened | F | 20 | Shell | library |
| demo-walk-through | F | 18 | Shell | application |
| .allstar | F | 16 | — | application |
| concourse-locks | F | 16 | — | application |

## Recommendations

### Quick Wins (high impact, low effort)

1. **Pinned dependencies (Actions SHA)** — Pin all GitHub Actions to full commit SHA (affects 118 repos)
1. **Token permissions** — Add explicit permissions block to GitHub Actions workflows (affects 115 repos)
